...
void MPU6050_demo(void)
{
	...
	/* Initialize MPU6050 sensor */
		if (MPU6050_Init(&MPU6050_Data, GPIOB, GPIO_PIN_5, MPU6050_Device_0, MPU6050_Accelerometer_4G, MPU6050_Gyroscope_2000s) != MPU6050_Result_Ok) {
	...
	/* Initialize MPU6050 sensor */
		...
		while (1) {
			...
			debug_printf("AX%4d\tAY%4d\tAZ%4d\tGX%4d\tGY%4d\tGZ%4d\tgx%4ld∞\tgy%4ld∞\tgz%4ld∞\tT%3.1f∞\n",
							...
							MPU6050_Data.Accelerometer_Y/410,	//environ en %
							MPU6050_Data.Accelerometer_Z/410);	//environ en %
			if ((MPU6050_Data.Accelerometer_X/410) + (MPU6050_Data.Accelerometer_Y/410) + (MPU6050_Data.Accelerometer_Z/410) >= 25
				||(MPU6050_Data.Accelerometer_X/410) + (MPU6050_Data.Accelerometer_Y/410) + (MPU6050_Data.Accelerometer_Z/410) <= -25)
			{
				return TRUE;
			}
			/* Little delay */
