...
//Ces macros permettent d'utiliser dans le code des noms explicites (LED_GREEN, ...)
	...
	#define BLUE_BUTTON_PIN 		GPIO_PIN_10		//Pas de bouton sur la bluepill, choisissez le port souhaité si vous en reliez un.
	#define LED_MATRIX_PORT_DATA	GPIOB
	#define LED_MATRIX_PIN_DATA 	GPIO_PIN_1		//DATA Matrice LED
#endif
